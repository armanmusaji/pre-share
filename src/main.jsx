      ...
      <main id="workspace">
        ...
        <div className={`meeting-layout ${inspecting ? 'inspecting' : 'reading'}`}>
          <section className="notes-sheet" aria-labelledby="notes-title" hidden={inspecting && !preview}>
            <div className="document-heading"><div><p className="eyebrow">AI-generated draft</p><h2 id="notes-title">{preview ? 'Review the proposed changes' : 'Meeting recap'}</h2></div><button onClick={e=>openSource([],e)}>View transcript</button></div>
