...
function App() {
  ...
  function inspect() { setCorrecting(false); setNotice(''); setInspecting(true); setChoice(snapshot.classification); setConfirmed(snapshot.condition); setPreview(null); setRejection(null); }
  ...
  return <>
    ...
    <footer>Pre Share · A feature experiment by Arman Musaji · Pass 06 <span>No recording, task assignment, or sharing happens in this prototype.</span></footer>
